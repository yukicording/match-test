...
<?php foreach ($users as $user) { ?>
 <a href="core/pages/img/<?php foreach ($profile_img as $img) { ?><?php if ($img['kind'] == 3) { echo html_escape($img['body']); }?><?php } ?>" class="lightbox lightbox_main"><div class="exampleaaa">
     <a href="core/pages/img/<?php foreach ($profile_img as $img) { ?><?php if ($img['kind'] == 0) { echo html_escape($img['body']); }?><?php } ?>" class="lightbox"><img src="core/pages/img/<?php foreach ($profile_img as $img) { ?><?php if ($img['kind'] == 0) { echo html_escape($img['body']); }?><?php } ?>" alt=""></a>
...
if ($user['age'] === 52) echo "69";
       ?>）</p><img src="core/pages/img/<?php foreach ($profile_img as $img) { ?><?php if ($img['kind'] == 3) { echo $img['body']; }?><?php } ?>" alt=""></div><div class="qwee"><a href="core/pages/img/<?php foreach ($profile_img as $img) { ?><?php if ($img['kind'] == 1) { echo $img['body']; }?><?php } ?>" class="lightbox"><img class="nbvc" src="core/pages/img/<?php foreach ($profile_img as $img) { ?><?php if ($img['kind'] == 2) { echo $img['body']; }?><?php } ?>" alt="" ></a></div>
     <div class="qweee"><a href="core/pages/img/<?php foreach ($profile_img as $img) { ?><?php if ($img['kind'] == 2) { echo $img['body']; }?><?php } ?>" class="lightbox"><img src="core/pages/img/<?php foreach ($profile_img as $img) { ?><?php if ($img['kind'] == 1) { echo $img['body']; }?><?php } ?>" alt="" ></a></div>
     </div></a>
...
nurse"; 
                                 ...
                                 if ($user['work'] === 53) echo "Dental hygienist"; 
...
Irregular";
    ...
    ?>
     <?php if(!empty($user['cohabitants'])) {echo "<p>Housemate：";
                                 if ($user['cohabitants'] === 1) echo "Living alone";
                                 ...
                                 if ($user['cohabitants'] === 5) echo "living with pet";
